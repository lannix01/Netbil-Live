...
<body>
  ...
  <div class="login-card">
    ...
    {{-- Flash Message --}}
@if (session('status'))
  <div class="mb-4 px-4 py-2 text-green-700 bg-green-100 border border-green-300 rounded text-sm text-center">
    {{ session('status') }}
  </div>
@endif
...
{{-- Error Display --}}
@if ($errors->any())
  <div class="mb-4 px-4 py-2 text-red-700 bg-red-100 border border-red-300 rounded text-sm text-center">
    {{ $errors->first() }}
  </div>
@endif
    <form method="POST" action="{{ route('login') }}">
      ...
      <div class="input-group">
        <input id="email" name="email" type="email" value="{{ old('email') }}" required autofocus placeholder=" " class="form-input" />
