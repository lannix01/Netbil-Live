...
@section('page-title', 'Create Item Group')
@section('page-subtitle', 'Create a group to organize items for receiving, assignments, and reporting.')
...
<div class="inv-card inv-form-card">
    <div class="inv-form-head">
        <div>
            <p class="inv-form-title mb-0">Create Item Group</p>
            <div class="inv-form-sub">Groups keep item lists clean and make reporting easier.</div>
        </div>
        <div class="inv-actions-right">
            Example groups: <span class="inv-chip">Fiber</span> <span class="inv-chip">Tools</span> <span class="inv-chip">Routers</span>
        </div>
    </div>

    <div class="inv-form-body">
        <form method="POST" action="{{ route('inventory.item-groups.store') }}" data-inv-loading>
            @csrf
            ...
            <div class="inv-grid">
                <div class="inv-field">
                    ...
                    <input
                        ...
                        required
                    />
                    <div class="inv-hint">Displayed on item create/edit and item lists.</div>
                    @if($hasErr('name'))
                ...
                <div class="inv-field">
                    ...
                    <input
                        ...
                        placeholder="e.g. FIB"
                    />
                    <div class="inv-hint">Short code for quick identification/search.</div>
                    @if($hasErr('code'))
                ...
                <div class="inv-field" style="grid-column:1 / -1;">
                    ...
                    <textarea
                        ...
                        name="description"
                        rows="3"
                        placeholder="Optional details about what belongs in this group…"
                    >{{ $oldDesc }}</textarea>
                    <div class="inv-hint">Optional. Keep it short.</div>
